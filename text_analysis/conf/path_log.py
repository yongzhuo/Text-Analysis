...
# @author  : Mo
# @function: logger of text-analysis


from text_analysis.conf.path_config import path_log_dir
...
fHandler = RotatingFileHandler(log_name_day, maxBytes=32*1024, backupCount=5)
